...
public class BezierCollider2DEditor : Editor
{
    ...
    void OnSceneGUI()
    {
        if (bezierCollider != null)
        {
            ...
            var fmh_66_138_639165908356879016 = Quaternion.identity; bezierCollider.firstPoint = Handles.FreeMoveHandle(bezierCollider.transform.position + ((Vector3)bezierCollider.firstPoint), 0.04f * HandleUtility.GetHandleSize(bezierCollider.transform.position + ((Vector3)bezierCollider.firstPoint)), Vector3.zero, Handles.DotHandleCap) - bezierCollider.transform.position;
            var fmh_67_140_639165908356927858 = Quaternion.identity; bezierCollider.secondPoint = Handles.FreeMoveHandle(bezierCollider.transform.position + ((Vector3)bezierCollider.secondPoint), 0.04f * HandleUtility.GetHandleSize(bezierCollider.transform.position + ((Vector3)bezierCollider.secondPoint)), Vector3.zero, Handles.DotHandleCap) - bezierCollider.transform.position;
            var fmh_68_152_639165908356937382 = Quaternion.identity; bezierCollider.handlerFirstPoint = Handles.FreeMoveHandle(bezierCollider.transform.position + ((Vector3)bezierCollider.handlerFirstPoint), 0.04f * HandleUtility.GetHandleSize(bezierCollider.transform.position + ((Vector3)bezierCollider.handlerFirstPoint)), Vector3.zero, Handles.DotHandleCap) - bezierCollider.transform.position;
            var fmh_69_154_639165908356947676 = Quaternion.identity; bezierCollider.handlerSecondPoint = Handles.FreeMoveHandle(bezierCollider.transform.position + ((Vector3)bezierCollider.handlerSecondPoint), 0.04f * HandleUtility.GetHandleSize(bezierCollider.transform.position + ((Vector3)bezierCollider.handlerSecondPoint)), Vector3.zero, Handles.DotHandleCap) - bezierCollider.transform.position;
